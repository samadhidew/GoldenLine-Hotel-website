<%-- 
    Document   : signin
    Created on : Jan 5, 2022, 6:47:17 PM
    Author     : ASUS
--%>
            ...
            <div class="container">
                ...
                <div class="row block-9">
                    <div class="col-md-6 order-md-last d-flex">
                        <form method="post" action="signin" class="bg-white p-5 signin-form">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Enter your username" required name="cusername">
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control" placeholder="Enter your password" id = "myInput" required name="cpass">
                            ...
                            <div class="form-group">
                                <p>Don't have an account ?<a href="RegisterCus.jsp"> Join Now</a></p>
                            </div>
                        </form>
                    </div>
                </div>
